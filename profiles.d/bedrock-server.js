...
exports.profile = {
  ...
  handler: function (profile_dir, callback) {
    ...
    try {  // BEGIN PARSING LOGIC
      ...
      item['id'] = 'bedrock-server-1.19.50.25';
      item['type'] = 'preview';
      item['group'] = 'bedrock-server';
      item['webui_desc'] = '1.19.50.25 Linux x64 preview';
      item['weight'] = 0;
      item['filename'] = 'bedrock-server-1.19.50.25.zip';
      item['downloaded'] = fs.existsSync(path.join(profile_dir, item.id, item.filename));
      item['version'] = 0;
      item['release_version'] = '1.19.50.25';
      item['url'] = 'https://minecraft.azureedge.net/bin-linux-preview/bedrock-server-1.19.50.25.zip';
      p.push(JSON.parse(JSON.stringify(item)));	 

      item['id'] = 'bedrock-server-1.19.41.01';
      item['type'] = 'release';
      item['group'] = 'bedrock-server';
      item['webui_desc'] = '1.19.41.01 Linux x64 release';
      item['weight'] = 0;
      item['filename'] = 'bedrock-server-1.19.41.01.zip';
      item['downloaded'] = fs.existsSync(path.join(profile_dir, item.id, item.filename));
      item['version'] = 0;
      item['release_version'] = '1.19.41.01';
      item['url'] = 'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.19.41.01.zip';
      p.push(JSON.parse(JSON.stringify(item)));	 

      item['id'] = 'bedrock-server-1.19.40.02';
      item['type'] = 'release';
      item['group'] = 'bedrock-server';
      item['webui_desc'] = '1.19.40.02 Linux x64 release';
      item['weight'] = 0;
      item['filename'] = 'bedrock-server-1.19.40.02.zip';
      item['downloaded'] = fs.existsSync(path.join(profile_dir, item.id, item.filename));
      item['version'] = 0;
      item['release_version'] = '1.19.40.02';
      item['url'] = 'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.19.40.02.zip';
      p.push(JSON.parse(JSON.stringify(item)));	 

      item['id'] = 'bedrock-server-1.19.31.01';
      item['type'] = 'release';
      item['group'] = 'bedrock-server';
      item['webui_desc'] = '1.19.31.01 Linux x64 release';
      item['weight'] = 0;
      item['filename'] = 'bedrock-server-1.19.31.01.zip';
      item['downloaded'] = fs.existsSync(path.join(profile_dir, item.id, item.filename));
      item['version'] = 0;
      item['release_version'] = '1.19.31.01';
      item['url'] = 'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.19.31.01.zip';
      p.push(JSON.parse(JSON.stringify(item)));	 

      item['id'] = 'bedrock-server-1.19.30.04';
      item['type'] = 'release';
      item['group'] = 'bedrock-server';
      item['webui_desc'] = '1.19.30.04 Linux x64 release';
      item['weight'] = 0;
      item['filename'] = 'bedrock-server-1.19.30.04.zip';
      item['downloaded'] = fs.existsSync(path.join(profile_dir, item.id, item.filename));
      item['version'] = 0;
      item['release_version'] = '1.19.30.04';
      item['url'] = 'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.19.30.04.zip';
      p.push(JSON.parse(JSON.stringify(item)));	 

      item['id'] = 'bedrock-server-1.19.22.01';
      item['type'] = 'release';
      item['group'] = 'bedrock-server';
      item['webui_desc'] = '1.19.22.01 Linux x64 release';
      item['weight'] = 0;
      item['filename'] = 'bedrock-server-1.19.22.01.zip';
      item['downloaded'] = fs.existsSync(path.join(profile_dir, item.id, item.filename));
      item['version'] = 0;
      item['release_version'] = '1.19.22.01';
      item['url'] = 'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.19.22.01.zip';
      p.push(JSON.parse(JSON.stringify(item)));	 

      item['id'] = 'bedrock-server-1.19.21.01';
      item['type'] = 'release';
      item['group'] = 'bedrock-server';
      item['webui_desc'] = '1.19.21.01 Linux x64 release';
      item['weight'] = 0;
      item['filename'] = 'bedrock-server-1.19.21.01.zip';
      item['downloaded'] = fs.existsSync(path.join(profile_dir, item.id, item.filename));
      item['version'] = 0;
      item['release_version'] = '1.19.21.01';
      item['url'] = 'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.19.21.01.zip';
      p.push(JSON.parse(JSON.stringify(item)));	 

      item['id'] = 'bedrock-server-1.19.20.02';
      item['type'] = 'release';
      item['group'] = 'bedrock-server';
      item['webui_desc'] = '1.19.20.02 Linux x64 release';
      item['weight'] = 0;
      item['filename'] = 'bedrock-server-1.19.20.02.zip';
      item['downloaded'] = fs.existsSync(path.join(profile_dir, item.id, item.filename));
      item['version'] = 0;
      item['release_version'] = '1.19.20.02';
      item['url'] = 'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.19.20.02.zip';
      p.push(JSON.parse(JSON.stringify(item)));	 

      item['id'] = 'bedrock-server-1.19.11.01';
      item['type'] = 'release';
      item['group'] = 'bedrock-server';
      item['webui_desc'] = '1.19.11.01 Linux x64 release';
      item['weight'] = 0;
      item['filename'] = 'bedrock-server-1.19.11.01.zip';
      item['downloaded'] = fs.existsSync(path.join(profile_dir, item.id, item.filename));
      item['version'] = 0;
      item['release_version'] = '1.19.11.01';
      item['url'] = 'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.19.11.01.zip';
      p.push(JSON.parse(JSON.stringify(item)));	 

      item['id'] = 'bedrock-server-1.19.10.03';
      item['type'] = 'release';
      item['group'] = 'bedrock-server';
      item['webui_desc'] = '1.19.10.03 Linux x64 release';
      item['weight'] = 0;
      item['filename'] = 'bedrock-server-1.19.10.03.zip';
      item['downloaded'] = fs.existsSync(path.join(profile_dir, item.id, item.filename));
      item['version'] = 0;
      item['release_version'] = '1.19.10.03';
      item['url'] = 'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.19.10.03.zip';
      p.push(JSON.parse(JSON.stringify(item)));	 

      item['id'] = 'bedrock-server-1.19.2.02';
      item['type'] = 'release';
      item['group'] = 'bedrock-server';
      item['webui_desc'] = '1.19.2.02 Linux x64 release';
      item['weight'] = 0;
      item['filename'] = 'bedrock-server-1.19.2.02.zip';
      item['downloaded'] = fs.existsSync(path.join(profile_dir, item.id, item.filename));
      item['version'] = 0;
      item['release_version'] = '1.19.2.02';
      item['url'] = 'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.19.2.02.zip';
      p.push(JSON.parse(JSON.stringify(item)));	 

      item['id'] = 'bedrock-server-1.19.1.01';
      item['type'] = 'release';
      item['group'] = 'bedrock-server';
      item['webui_desc'] = '1.19.1.01 Linux x64 release';
      item['weight'] = 0;
      item['filename'] = 'bedrock-server-1.19.1.01.zip';
      item['downloaded'] = fs.existsSync(path.join(profile_dir, item.id, item.filename));
      item['version'] = 0;
      item['release_version'] = '1.19.1.01';
      item['url'] = 'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.19.1.01.zip';
      p.push(JSON.parse(JSON.stringify(item)));	 
